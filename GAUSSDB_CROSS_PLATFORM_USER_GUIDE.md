...
> 工行 26.1.5 开发分支说明（2026-09-21）：下文保留 09-18 交付指南历史。此分支已迁移到真正的 26.1.5 基线，并取消调试层仅凭 M 标签的直接拒绝；但 507 M 库创建 PL/SQL/Package 仍被服务端拒绝，不能宣称工行原始需求完成。当前状态以 [迁移与验证报告](ICBC_2615_507_VALIDATION_20260921.md) 为准，旧 Windows 26.2.0 发布包未被替换。
