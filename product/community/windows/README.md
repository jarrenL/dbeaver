...
4. With NSIS 3 on a supported build host, run `makensis -DRELEASE=20260918 -DPAYLOAD=/absolute/output/dbeaver -DREMOVE_MANIFEST=/absolute/output/remove-files.nsh -DOUTPUT=/absolute/output/dbeaver-gaussdb-26.2.0-windows-x86_64-setup.exe product/community/windows/gaussdb-installer.nsi`. On Windows NSIS, use the appropriate `/D` argument syntax.
