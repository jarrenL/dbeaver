...
> 2026-09-21 工行范围更新：存储过程/函数 PL/SQL 调试、事务控制及 Package 编译排错在 O（Oracle）兼容库验收；M 仅要求基础连接、元数据、SQL 和数据维护。M PL/SQL/Package 为 N/A，不作为缺口。当前 26.1.5 分支的 [范围核对报告](../../ICBC_REQUIREMENTS_SCOPE_20260921.md) 优先于下文历史状态。
